...
export default function GateSignoffContact({ contact, className = "" }) {
  ...
  return (
    <div className={`gate-signoff-contact${className ? ` ${className}` : ""}`}>
      <div className="about-signoff">
        <span className="about-signoff-rule" aria-hidden="true" />
        <div className="about-cta">
          <p>
            Right now I&apos;m at an intersection of my career. Seeking a role where all my skills
            align to create unparalleld value.
          </p>
          <p className="about-cta-question">Will it be with you?</p>
          <p className="about-cta-touch">
            Let&apos;s find out. Get in touch below
            <svg className="about-cta-arrow" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <div className="gate-contact">
        <a href={`mailto:${contact.email}`} className="gate-contact-link" aria-label="Email">
